...
- `docs/` — long-form editor walkthrough.
...
source locally, clone the [MoUI](https://github.com/wzzc-dev/MoUI) repository
and use its `scripts/window-dev-mode.sh` there.
