...
- [view_chrome.mbt](app/view_chrome.mbt)：chrome、status_bar、outer column、workspace 组装
- [view_editor_surface.mbt](app/view_editor_surface.mbt)：editor_source_layout、editor_page、target_bar、inspectors
- [view_inspectors.mbt](app/view_inspectors.mbt)：files/outline/info/source inspector 实现
- [view_toolbar.mbt](app/view_toolbar.mbt)：chrome 内的按钮组
- [view_toasts.mbt](app/view_toasts.mbt)：toast_layer 和 confirm_dialog
